...
public class UserOfComparability {
    ...
    public static void main(String[] commandLine) {
        ...
        // Date vs. itself
        Date d0 = new Date( 1, 2, 3);
        reportRelationshipDate( "Date vs. itself", d0, d0, "0");

        // Date vs. date more
        reportRelationshipDate( "Date vs. point closer to origin", d0
                          , new Date( 3, 2, 3), "positive int");

        // Date vs. date less
        reportRelationshipDate( "Date vs. distant point", d0
                          , new Date( 1, 2, 1), "negative int");
    ...
    private static void reportRelationshipDate 
      ( String description
      , Date a
      , Date b
      , String expect
